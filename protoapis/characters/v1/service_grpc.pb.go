...
const (
	Service_Create_FullMethodName   = "/characters.v1.Service/Create"
	Service_Retrieve_FullMethodName = "/characters.v1.Service/Retrieve"
	Service_Update_FullMethodName   = "/characters.v1.Service/Update"
	Service_Delete_FullMethodName   = "/characters.v1.Service/Delete"
	Service_List_FullMethodName     = "/characters.v1.Service/List"
)
...
func (c *serviceClient) Retrieve(ctx context.Context, in *RetrieveRequest, opts ...grpc.CallOption) (*RetrieveResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_Retrieve_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_Retrieve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_Retrieve_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "characters.v1.Service",
	...
	Metadata: "characters/v1/service.proto",
}
